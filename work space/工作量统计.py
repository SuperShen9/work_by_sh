...
#     k += 1
#     print('文件类型：{} - 数量：{} - 百分比：{}%'.format(dict,type_list.count(dict),
#                 round(float(type_list.count(dict))/float(len(type_list))*100),2))
#     df.loc[k, 'Type'] = dict
...
df=pd.read_csv('C:\Users\Administrator\Desktop\work.csv')

# print df
# exit()

print df.sort_values('count', ascending=0)